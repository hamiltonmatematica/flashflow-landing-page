      ...
      <div className="max-w-5xl mx-auto text-center space-y-16">
        ...
        <div className="pt-12">
          <a href="https://pay.kiwify.com.br/lTezrlP" target="_blank" rel="noopener noreferrer">
            <button className="cta-button py-5 px-12 rounded-2xl text-lg md:text-xl font-extrabold uppercase tracking-wider bg-[#1CBA5C] hover:bg-[#158C47] text-white transition-all shadow-2xl shadow-emerald-500/40 hover:shadow-emerald-500/60">
